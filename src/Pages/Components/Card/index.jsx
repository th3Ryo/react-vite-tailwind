...
function Card({ID, title, description, price, category, image }) {
  ...
  return (
    <div
      className="container bg-gradient-to-l from-red-800 to-orange-400 w-[216px]  h-[264px] p-1 rounded-md overflow-visible flex items-center relative text-white text-center"
      // se remplazo la arrow function por el context.openDetail() por la costante handleCardClick
      onClick={handleCardClick}
    >
      <div className="box relative w-[208px]  h-[256px] bg-gray-900 flex justify-center items-center rounded-lg">
